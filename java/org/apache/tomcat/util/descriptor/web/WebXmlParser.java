...
public class WebXmlParser {
    ...
    /**
     * Configure XXE protection on a Digester instance by disabling
    ...
    private void configureXxeProtection(Digester digester) {
        ...
        try {
            ...
            log.warn("Could not set feature external-general-entities", e);
        }
        try {
            digester.setFeature("http://xml.org/sax/features/external-parameter-entities", false);
        } catch (Exception e) {
            log.warn("Could not set feature external-parameter-entities", e);
        }
        try {
            digester.setFeature("http://apache.org/xml/features/nonvalidating/load-external-dtd", false);
        } catch (Exception e) {
            log.warn("Could not set feature load-external-dtd", e);
        }
    }
